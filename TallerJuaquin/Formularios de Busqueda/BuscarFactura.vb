...
#Region "Funciones"
    ...
    Private Sub AnchoColumna(Optional ByVal Inicio As Boolean = False)
        ...
        If GetRowOpciones.anMarca = 0 And GetRowOpciones.anMatricula = 0 And GetRowOpciones.anModelo = 0 Then
            ...
            GetRowOpciones.anTotal = cClientes.Columns("Total").Width
        ...
        ElseIf Inicio Then
            ...
            cClientes.Columns("Total").Width = GetRowOpciones.anTotal
...
#Region "Eventos"
    ...
    Private Sub BuscarCliente_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cnn.Open()
        Dim cmd As New SqlClient.SqlCommand("select Historial.IDHistorial,IDCliente,TipoPOF,Coche.IDCoche,Matricula,Marca,Modelo,Color,Total,FechaEntrada,FechaSalida,Observaciones from Coche,Historial,POF where Coche.IDCoche=Historial.IDCoche and Historial.IDHistorial=POF.IDHistorial order by FechaEntrada Desc", cnn)
    ...
    Private Sub cAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cAceptar.Click, cClientes.DoubleClick
        If cClientes.SelectedRows.Count > 0 Then
            ...
            Me.Close()
        Else
            MsgBox("No ha seleccionado ninguna factura")
        End If
    End Sub
