...
namespace System.Windows.Forms.Calendar
{
        ...
        : CalendarSelectableElement
    {
        ...
        /// <param name="endDate">End date of the item</param>
        /// <param name="text">Text of the item</param>
        public CalendarItem(Calendar calendar,int _IDitem, DateTime startDate, DateTime endDate, string text)
            : this(calendar)
        {
            IDItem = _IDitem;
            StartDate = startDate;
        ...
        /// <param name="endDate">End date of the item</param>
        /// <param name="text">Text of the item</param>
        public CalendarItem(Calendar calendar, int _IDitem, DateTime startDate, DateTime endDate, string text,DateTime fechaaviso)
            : this(calendar)
        {
            IDItem = _IDitem;
            StartDate = startDate;
        ...
        /// </remarks>
        public virtual DateTime FechaAviso
        {
